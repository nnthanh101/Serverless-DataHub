...
export interface EcsFargateServiceConstructProps  {
  ...
  readonly environmentECS?: {
    [key: string]: string;
  };
  readonly healthyCheckTimeout: number;
  readonly healthyCheckInterval: number;
  ...
  constructor(parent: cdk.Construct, id: string, props: EcsFargateServiceConstructProps) {
    ...
    const appContainer = new ContainerDefinition(
      ...
      { 
        ...
        environment: props.environmentECS,
    ...
    props.loadBalancerListener.addTargets(id + "-listenerTg", {
      ...
      healthCheck:{ 
        ...
        timeout: Duration.seconds(props.healthyCheckTimeout), 
        interval: Duration.seconds(props.healthyCheckInterval),
